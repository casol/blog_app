...
# View which retrieving all the post with the published status
# using published manager created in models.
def post_list(request, tag_slug=None, category=None):
